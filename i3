...
# Launcher
bindsym $mod+space exec "rofi -no-fixed-num-lines -drun-display-format {name} -display-drun 'λ' -modi drun,window,emoji -show drun -font 'Iosevka Aile 33' -lines 6 -yoffset 256 -location 2"
# Telegram
